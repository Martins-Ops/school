...
function Footer() {
  return (
    <div className="bg-gray-700 w-full mt-20 md:flex py-8 px-4 md:px-8 md:gap-10 justify-center">
      <div className="w-full md:w-1/3 my-10">
        <img src={logo} className="w-32 h-32 justify-center" alt="logo" />
        <h2 className="text-red-600 text-xl my-2 text-bold">ST PAUL COLLEGE</h2>
      </div>
